...
To check the endpoint before any poll changes, choose **Send test event** from its menu. Kinpal sends a signed [`ping`](/api-reference/webhooks/events#test-events) and shows the response it got back.
