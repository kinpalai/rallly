...
<Card title="Key Benefits" icon="rocket">
  ...
  - **Optional Collaboration**: Choose whether members work together or keep their scheduling private
...
<CardGroup cols={2}>
  ...
  <Card title="Collaboration" icon="handshake" href="/spaces/collaboration">
    Choose whether members work together or independently
  </Card>
