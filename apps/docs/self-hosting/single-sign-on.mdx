...
Kinpal supports three SSO options: Google, Microsoft (Entra ID), and any provider that speaks OpenID Connect (OIDC). You can enable more than one at a time.
...
If your identity provider supports OAuth 2.0 with OpenID Connect, you can use it to authenticate users on your Kinpal instance.
