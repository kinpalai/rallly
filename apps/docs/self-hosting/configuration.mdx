...
<ParamField path="KINPAL_IMAGE" default="opencompute/rallly:4">
  Override the Kinpal Docker image. Pin a major version (e.g. `opencompute/rallly:4`) to avoid pulling in breaking changes. See the [releases](https://github.com/opencompute/rallly/releases) for available versions.
</ParamField>
