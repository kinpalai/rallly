...
<ParamField path="KINPAL_IMAGE" default="kinpalai/rallly:4">
  Override the Kinpal Docker image. Pin a major version (e.g. `kinpalai/rallly:4`) to avoid pulling in breaking changes. See the [releases](https://github.com/kinpalai/rallly/releases) for available versions.
</ParamField>
