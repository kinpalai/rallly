...
icon: "circle-1"
title: "Create a poll"
description: "How to create a scheduling poll with Kinpal"
---

Go to [app.kinpal.com](https://app.kinpal.com) and click **Create**, or go
straight to [app.kinpal.com/new](https://app.kinpal.com/new).
