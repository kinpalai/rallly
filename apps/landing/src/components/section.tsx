...
export function SectionTitle({
  ...
  return (
    <h2
      className={cn(
        "text-balance font-medium text-2xl text-foreground leading-tight tracking-tight sm:text-4xl",
        className,
      )}
      {...props}
    />
...
export function SectionDescription({
  ...
  return (
    <p
      className={cn(
        "max-w-prose text-pretty text-base/6 text-muted-foreground sm:text-lg",
        className,
      )}
      {...props}
    />
