...
**This announcement is only relevant to self-hosted Kinpal installations.** If you use Kinpal's hosted service at [rallly.co](https://rallly.co), you do not need to take any action. The servers were patched within hours of the CVEs being announced, and there was no breach during that time.
...
- **Update** Kinpal to the latest version (v4.5.11 or later) to be protected against all four CVEs. See the [release notes](https://github.com/lukevella/rallly/releases/tag/v4.5.11) for details.
