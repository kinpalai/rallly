...
Features like this take significant time to build and maintain. Offering white labeling as a paid add-on helps generate the revenue needed to keep developing new features and maintaining the project long-term. If your organization is interested in white labeling or other enterprise features, please fill out the [Enterprise Requirements Survey](https://app.formbricks.com/s/cmebvnf2ohvjkt901eefxsonr).

## What's Next?

I'm planning to bring branding customization to the space level as well. This will allow teams on the cloud-hosted version to customize their spaces with their own branding without needing to self-host.
